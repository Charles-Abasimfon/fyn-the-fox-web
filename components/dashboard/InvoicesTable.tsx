...
export interface InvoicesTableProps {
  items: InvoiceItem[];
  onView?: (item: InvoiceItem) => void;
  onSend?: (item: InvoiceItem) => void | Promise<void>;
  onDelete?: (item: InvoiceItem) => void | Promise<void>;
  onViewAttachment?: (item: InvoiceItem) => void;
}
  ...
  return (
    <div className='bg-[#FFFFFF05] rounded-lg overflow-hidden'>
      ...
      <div className='flex flex-col gap-3 py-4 sm:flex-row sm:items-center sm:justify-between'>
        <h2 className='text-white text-lg font-semibold'>My Invoices</h2>
        {/* Search */}
      ...
      {total > 0 && (
        <div className='flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between py-4'>
          <div className='text-[#BDBDBE] text-sm'>
            Showing {startIndex} to {endIndex} of {total} invoices
          </div>
